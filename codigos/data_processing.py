...
def process_issues(issues_updated, issues_author, author_ids=None, updated_date_range=None, created_date_range=None):
    data_updated = []
    data_author = []
    additional_fields_data_updated = []
    additional_fields_data_author = []
